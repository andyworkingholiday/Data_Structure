...
public:
	...
	*/
	...
	/**
	*	@brief	Program driver of Master List.
	*	@pre	Master List program is started.
	*	@post	Master List program is finished.
	*/
	void RunMaster();

	/**
	*	@brief	Program driver of Temporary List.
	*	@pre	Temporary List program is started.
	*	@post	Temporary List program is finished.
	*/
	void RunTemp();

	/**
	*	@brief	Program driver of Container List.
	*	@pre	Container List program is started.
	*	@post	Container List program is finished.
	*/
	void RunContainer();
...
private:
	...
	TempType TempList; // Temporary List
	SortedList<ItemType> MasterList; // Master List all the Item put
