...
public:
	...
	*	default constructor.
	*/
	MainApplication() { m_Command = 0; }

	/**
	*	parameterized constructor.
	*/
	MainApplication(UserType& _user) {
		m_Command = 0;
		User = _user;
	}
	...
	*/
	...
	/**
	*	@brief	Search item by Heart from the Master List
	*	@pre	list should be initalized
	*	@post	find the item with the Heart
	*	@return	return 1 if this function works well, otherwise 0.
	*/
	void RetrieveByHeart();
