...
public:
	...
	*/
	ItemType(int inUsage, int inSID, int inCID, string inRtime, string inBrand, string inName, int inNum, int inItemNum) {
	...
	*	@param	inItemNum	 Primary KeyNumber
	*/
	void SetRecord(int inUsage, int inSID, int inCID, string inRtime, string inBrand, string inName, int inNum, int inItemNum) {
		SetUsage(inUsage);
		SetStorageId(inSID);
